...
namespace IGestao\Units\Laboratory\Product\Providers;

use Illuminate\Foundation\Support\Providers\RouteServiceProvider as ServiceProvider;
use Illuminate\Support\Facades\Route;
use IGestao\Units\Laboratory\Product\Http\Routes\Api;
...
class RouteServiceProvider extends ServiceProvider
{
     ...
     * @var string
     */
    protected $namespace = 'IGestao\Units\Laboratory\Product\Http\Controllers';
