...
namespace IGestao\Units\Laboratory\Sector\Providers;

use Illuminate\Foundation\Support\Providers\RouteServiceProvider as ServiceProvider;
use Illuminate\Support\Facades\Route;
use IGestao\Units\Laboratory\Sector\Http\Routes\Api;
...
class RouteServiceProvider extends ServiceProvider
{
     ...
     * @var string
     */
    protected $namespace = 'IGestao\Units\Laboratory\Sector\Http\Controllers';
